...
Next time, I can pick two locations that are more geographically similar, like the same county or city. I did not anticipate the amount of terms that only appear once or twice that make up the bulk of the word cloud.
